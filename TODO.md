...
- [x] add documentation for deslopification, tests, tools, and root artifacts in the docs folder
...
- [x] fix `.vscode/settings.json` `luacheck.config` path to workspace-relative form
