...
- Target branch (default): `feature/22-doit-migration-evaluation` (or as user-directed for current workflow)
...
1. Run issue preflight:
   - `python tools/session_preflight.py --mode issue --issue-number 22 --issue-kind enhancement --slug doit-migration-evaluation`
