...
### Changed
- `SensorList` touch handling now uses the verified Ethos touch event contract (`EVT_TOUCH` values `16640/16642/16641`).
...
### Fixed
- Added fallback long-press detection on touch end when native `EVT_TOUCH_LONG` is unavailable.
