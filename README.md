...
If you want to play around with finding repeatable, low-maintenance ways to deslopify and generate decent scripts / utilities to make our RC hobbist lives easier, let see those PRs :)
